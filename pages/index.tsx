	...
	return (
		<div className="flex flex-col mt-16 w-full">
			...
			<div className="w-full grid gap-4 grid-cols-2 grid-rows-4 lg:grid-cols-4 lg:grid-rows-2">
				...
				<div className="bg-white col-span-2 p-8 row-span-1 h-full rounded-2xl shadow flex gap-6 justify-center items-center dark:bg-slate-800 lg:col-span-2 lg:row-span-1 lg:min-h-[180px]">
					<p className="text-5xl font-semibold text-slate-300 dark:text-slate-500">
						PROJECTS
					</p>
					<svg
				...
				<div className="bg-white col-span-1 p-8 row-span-1 h-full w-full rounded-2xl shadow flex gap-6 justify-center items-center dark:bg-slate-800 lg:col-span-1 lg:row-span-1 lg:min-h-[180px]">
					<svg
						className="fill-slate-300 dark:fill-slate-500"
						width="64"
						height="53"
