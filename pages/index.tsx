	...
	return (
		<div className="flex flex-col mt-16 w-full">
			...
			<div className="w-full grid gap-4 grid-cols-2 grid-rows-4 lg:grid-cols-4 lg:grid-rows-2">
				...
				<Link
					href={"/projects"}
					className="group bg-white col-span-2 p-8 row-span-1 h-full rounded-2xl shadow flex gap-6 justify-center items-center hover:bg-gray-100 dark:bg-slate-800 dark:hover:bg-slate-700 lg:col-span-2 lg:row-span-1 lg:min-h-[180px]"
				>
				...
				<Link
					...
					className="group bg-white col-span-1 p-8 row-span-1 h-full w-full rounded-2xl shadow flex gap-6 justify-center items-center hover:bg-gray-100 dark:bg-slate-800 dark:hover:bg-slate-700 lg:col-span-1 lg:row-span-1 lg:min-h-[180px]"
				>
					<svg
						className="fill-slate-300 group-hover:fill-slate-400 dark:fill-slate-500 dark:group-hover:fill-slate-400"
						width="64"
