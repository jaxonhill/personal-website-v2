...
export default function Home() {
	return (
		<div className="flex flex-col mt-16 w-full">
			<h1 className="text-3xl text-slate-800 font-semibold mb-6">Home</h1>
			<div className="w-full flex flex-col gap-4">
				<div className="bg-white p-6 rounded-2xl shadow">
					<h2 className="font-semibold text-2xl text-slate-800 pb-4">
						Hey I'm{" "}
				...
				<div className="bg-white p-6 h-40 rounded-2xl shadow flex gap-6 justify-center items-center">
					<p className="text-5xl font-semibold text-slate-600">
						PROJECTS
					</p>
					<svg
						width="32"
					...
					>
						<path
							d="M32 2.79865C32 2.09175 31.7192 1.4138 31.2193 0.91394C30.7195 0.414085 30.0415 0.133269 29.3346 0.133269L8.01159 0C7.30469 0 6.62674 0.280816 6.12688 0.780672C5.62703 1.28053 5.34621 1.95848 5.34621 2.66538C5.34621 3.37228 5.62703 4.05023 6.12688 4.55009C6.62674 5.04994 7.30469 5.33076 8.01159 5.33076H22.8311L0.788415 27.4268C0.538593 27.6745 0.340304 27.9693 0.204987 28.2941C0.069669 28.6189 0 28.9673 0 29.3192C0 29.671 0.069669 30.0194 0.204987 30.3442C0.340304 30.669 0.538593 30.9638 0.788415 31.2116C1.0362 31.4614 1.33099 31.6597 1.65579 31.795C1.98059 31.9303 2.32897 32 2.68083 32C3.0327 32 3.38108 31.9303 3.70588 31.795C4.03068 31.6597 4.32547 31.4614 4.57325 31.2116L26.6692 9.1156V23.9884C26.6692 24.6953 26.9501 25.3733 27.4499 25.8731C27.9498 26.373 28.6277 26.6538 29.3346 26.6538C30.0415 26.6538 30.7195 26.373 31.2193 25.8731C31.7192 25.3733 32 24.6953 32 23.9884V2.79865Z"
							fill="#475569"
						/>
					</svg>
				</div>
				<div className="flex gap-4">
					<div className="bg-white h-40 w-full rounded-2xl shadow flex gap-6 justify-center items-center">
						<svg
							width="64"
							height="53"
							viewBox="0 0 64 53"
